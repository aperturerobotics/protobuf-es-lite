...
import { Timestamp as Timestamp$1 } from "@bufbuild/protobuf";
 ...
 */
export interface Timestamp extends Message<Timestamp$1> {
  /**
...
export const Timestamp: MessageType<Timestamp$1> = createMessageType(
  {
...
export const EchoMsg: MessageType<EchoMsg> = createMessageType(
  {
    ...
    fields: [
        ...
        { no: 2, name: "ts", kind: "message", T: Timestamp$1 },
