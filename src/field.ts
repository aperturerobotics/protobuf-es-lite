...
// FieldListSource is the source field list passed to newFieldList.
...
type fiRules<T> = Omit<
  T,
  "oneof" | "repeat" | "repeated" | "packed" | "opt" | "req"
> &
  (
    | {
        readonly repeated: false;
...
type fiPartialRules<T extends fiScalar | fiMap | fiEnum | fiMessage> = Omit<
  T,
  | "jsonName"
  | "localName"
  | "oneof"
